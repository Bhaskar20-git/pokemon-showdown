...
exports.commands = {
	...
	credits: function (target, room, user) {
		let popup = "|html|" + "<font size=5 color=#0066ff><u>" + serverName + " Credits</b></u></font><br />" +
			...
			"- " + Server.nameColor('bhaskar20', true) + " (Owner, Policy + Technical Admin, Development,System Operator)<br />" +
			"- " + Server.nameColor('beekay1976', true) + " (Owner, Technical Admin, Development)<br />" +
			//"- " + Server.nameColor('todorokidelta', true) + " (Technical Admin, Development)<br />" +
			//"- " + Server.nameColor('A Flying Phantom', true) + " (Development, CSS)<br />" +
			"<br />" +
			"<u><b>Contributors:</b></u><br />" +
			"- " + Server.nameColor('Calem Xaiver', true) + " (Community Leader)<br />" +
			"- " + Server.nameColor('Shade Ritik', true) + " (Admin, Development)<br />" +
