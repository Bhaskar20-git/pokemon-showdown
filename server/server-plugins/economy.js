...
function getShopDisplay(shop) {
	let display = `<center><img src="https://play.pokemonshowdown.com/sprites/xyani/mewtwo-megax.gif" width="80" height="100"><psicon pokemon="mewtwo-megax"><img src="https://i.ibb.co/X5GMTdD/cooltext-357224916019354.png" width="300" height="100"><psicon pokemon="mewtwo-megay"><img src="https://play.pokemonshowdown.com/sprites/xyani/mewtwo-megay.gif" width="80" height="100"></center><br /><div class="infobox-limited"><table style="background: #000080; border-color: #C0C0C0; border-radius: 8px" border="1" cellspacing="0" cellpadding="5" width="100%"><tbody><tr><th><font color=#FFDF00 face=courier>Item</font></th><th><font color=#FFDF00 face=courier>Description</font></th><th><font color=#FFDF00 face=courier>Price</font></th></tr>`;
	let start = 0;
